...
<html>
	<head>
        ...
        {
          $("#accordion").accordion({ animate: 200, collapsible:true });
        })
    </script>
			    	...
			    	<div style="width:300px;float: left">
				    	<div style="width:100%">
					    	<p>
							  ...
							  <input type="text" id="temperatura${i}" readonly style="border:0; color:#f6931f; font-weight:bold;width:40px">
					  ...
					  $(function() {
					    ...
					    function checkStatus${i}(url, counter){
							  ...
							  $.ajax({
		        				    ...
		        				    data: JSON.stringify(parametros),
		        				    success: function(data) {
						        		if(data["status"]=="error" || counter==6){					        			
						        			$( "#warning${i}" ).css({"display":"block"})					        			
						        			actualizaBoton${i}(parametros)
						        		}					 
